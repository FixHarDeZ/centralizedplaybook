...
rm -rf "$searchDirapp/creditpay"

cp -r "$searchDirnano/creditpay" "$searchDirapp/creditpay"

cd /home/sysansible/prometheus/acm-ocp-prometheus-rules-apps;git add .;git commit -a -m "credit pay";git push origin nonprod
